...
import dev.acuon.sessions.ui.fragment.AllBreeds
import dev.acuon.sessions.ui.fragment.BreedImages
...
class MainActivity : AppCompatActivity(), MainActivityInterface {
    ...
    override fun setFragmentName(name: String) {
        binding.tvFragmentName.text = name
    }
